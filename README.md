...
![GIF DO JOGO EM FUNCIONAMENTO](https://github.com/otavioronsini/ArduinoSnake/blob/main/snake.gif)

## Montagem do joystick:

**VRX** - A0<br>
**VRY** - A1<br>
**SW** - 2 (Botão de pressão)<br>
**VCC** - 5V<br>
**GND** - GND

## Montagem da matriz de led:

**DIN** - 12 (Data In)<br>
**CS** - 11 (Chip Select)<br>
**CLK** - 10 (Clock)<br>
**VCC** - 5V<br>
**GND** - GND

## Código para testar o funcionamento do joystick:
...
## Código para testar o funcionamento da matriz de led:
